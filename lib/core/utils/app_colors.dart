...
class AppColors{
  static const Color primary = Color(0xffd9d0c1);
  ...
  static const Color grey = Color(0xFF677186);
  static const Color white = Color(0xFFFCFCFD);
  static const Color offWhite = Color(0xFFEEEAE5);
  static const Color red = Colors.red;
  static const Color black = Colors.black;
  static const Color gold = Color(0xfffa8334);
  static const Color green = Color(0xff0ac755);
  static const Color yellow = Color(0xfffab311);
}