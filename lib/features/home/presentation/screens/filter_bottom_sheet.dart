                    ...
                    Row(
                      children: [
                        ...
                        Container(
                          ...
                          child: CustomButton(
                            elevation: 0,
                            onPressed: () => BlocProvider.of<FilterCubit>(context).reset(), text: AppLocalizations.of(context)!.reset, w: 191.w, background: AppColors.white, textStyle: Theme.of(context).textTheme.displayLarge!.copyWith(fontSize: 16.h, color: AppColors.darkBlue),),
                        )
                      ],
                    )
                  ],
