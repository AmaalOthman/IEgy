      ...
      return Scaffold(
        ...
        body: Padding(
            padding: EdgeInsets.only(
                top: 32.h, bottom: 69.h, left: 16.w, right: 16.w),
            child: SingleChildScrollView(
                child: Column(children: [
              Row(mainAxisAlignment: MainAxisAlignment.spaceAround, children: [
                PageIndicator(
                    selected:
                        BlocProvider.of<MoreCubit>(context).currentPage == 1),
                PageIndicator(
                    selected:
                        BlocProvider.of<MoreCubit>(context).currentPage == 2),
                PageIndicator(
                    selected:
                        BlocProvider.of<MoreCubit>(context).currentPage == 3),
                PageIndicator(
                    selected:
        ...
        bottomNavigationBar: BlocProvider.of<MoreCubit>(context).currentPage < 4
            ? Padding(
