            ...
            body: Column(
              children: [
                          ...
                          Row(
                            children: [
                              ...
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(AppLocalizations.of(context)!.sofra, style: Theme.of(context)
                                      .textTheme
                                      .displaySmall!
                                      .copyWith(
                                      color: AppColors.darkBlue,
                          ...
                          Row(
                            children: [
                              ...
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(AppLocalizations.of(context)!.bedroom, style: Theme.of(context)
                                      .textTheme
                                      .displaySmall!
                                      .copyWith(
                                      color: AppColors.darkBlue,
                            ...
                            children: [
                              Text(AppLocalizations.of(context)!.total_amount,
                                  style: Theme.of(context)
                                      ...
                                      fontSize: 20.h, color: AppColors.brown)),
                              const Spacer(),
                              Text('19000 ${AppLocalizations.of(context)!.egp}', style: Theme.of(context).textTheme.displayLarge!.copyWith(color: AppColors.darkBlue))
                            ]
                          )
                        ])),
                const Spacer(),
                Container(
                  ...
                  child: CustomButton(onPressed: () {}, text: AppLocalizations.of(context)!.pay)
                )
              ]
            ));
      },
