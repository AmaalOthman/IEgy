                  ...
                  AppBar(
                      ...
                      actions: [
                        IconButton(
                            onPressed: () {},
                            icon: CustomImage(
                                imagePath: AppAssets.add, h: 24.w, w: 24.w))
                      ])
                ])),
              ...
              Row(children: [
                ...
                SizedBox(
                    ...
                    child: CustomTextFormField(
                        controller: TextEditingController(
                            text: BlocProvider.of<FavCubit>(context)
                                ...
                                : BlocProvider.of<FavCubit>(context)
                                    .spokenWords),
                        focusNode: BlocProvider.of<FavCubit>(context).focusNode,
                        shadow: true,
                        preIcon: const Icon(
                          Icons.search,
                        ...
                        onSuffixPressed: BlocProvider.of<FavCubit>(context)
                            .onVoiceSearchClicked)),
                SizedBox(width: 8.w),
                IconButton(
                  onPressed: () => BlocProvider.of<FavCubit>(context)
