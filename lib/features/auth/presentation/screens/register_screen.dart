                ...
                child: SingleChildScrollView(
                  ...
                  builder: (context, state) {
                    return Form(
                      ...
                      child: BlocBuilder<AuthCubit, AuthState>(
  builder: (context, state) {
    if(state is RegisterLoadingState) showDefaultLoadingIndicator(context, cancelable: false);
    if(state is RegisterErrorState) showDefaultDialog(context, type: NotificationType.error, description: state.errorMessage);
    return Column(children: [
                        ...
                        CustomTextFormField(
                            ...
                            preIcon:
                                const CustomImage(imagePath: AppAssets.locker),
                            isObSecure: true,
                            ...
                            validator: (data) {
                              ...
                              if (data != cubit.signUpPasswordController.text) {
                                return AppLocalizations.of(context)!
                        ...
                        Gap(16.h),
                        CustomButton(
                            onPressed: () => cubit.validateThenDoSignUp(context),
                        ...
                        Row(
                          ...
                          children: [
                            CustomButton(
                              ...
                              withIcon: true,
                              icon: CustomImage(
                                  imagePath: AppAssets.google, w: 28.w, h: 28),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            TextButton(onPressed: () => navigateLast(context: context, route: Routes.login),
