        ...
        return InkWell(
          ...
          child: Column(
            ...
            children: [
              ...
              if (state is! ShowLocationsState)
                GestureDetector(
                  onTap: () => state is! ShowLocationsState
                      ? BlocProvider.of<PaymentCubit>(context).showLocations()
                      : null,
                  child: Stack(
                    children: [
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(AppLocalizations.of(context)!.cairo,
                                style:
                                    dataStyle.copyWith(color: AppColors.brown)),
                            SizedBox(
                              height: 7.h,
                            ),
              ...
              DataInputField(
                focusNode:
                    BlocProvider.of<PaymentCubit>(context).phoneNumberFocusNode,
                      ...
                      child: InkWell(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(AppLocalizations.of(context)!.delivery_only,
                                style:
                                    dataStyle.copyWith(color: AppColors.brown)),
                            SizedBox(
                              height: 7.h,
